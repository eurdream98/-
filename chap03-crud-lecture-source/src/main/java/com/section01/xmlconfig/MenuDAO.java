...
public class MenuDAO {
    ...
    /* 해당 DAO에서 호출하는 이름으로는 menu-mapper.xml의 namespace에 있는 MenuMapper와 일치시켜야한다.
     * section02, section03까지 구현시 MenuMapper 링크가 section02로 연결되지만 실제로 사용하는 매퍼는 menu-mapper.xml 이다.
     * */
